...
export default class FlatListSlider extends Component<any> {
  slider = createRef();
    ...
    return (
      <View>
        <FlatList
          ...
          renderItem={({ item, index }) => <ChildItem style={{ width: this.props.width }} item={item} imageKey={this.props.imageKey} onPress={this.props.onPress ? () => this.props.onPress(item, index) : undefined} index={this.state.index % this.props.data.length} active={index === this.state.index} local={this.props.local} height={this.props.height} />}
        ...
        {this.props.indicator && (
          <Indicator itemCount={this.props.data.length} currentIndex={this.state.index % this.props.data.length} indicatorStyle={this.props.indicatorStyle} indicatorContainerStyle={[styles.indicatorContainerStyle, this.props.indicatorContainerStyle]} indicatorActiveColor={this.props.indicatorActiveColor} indicatorInActiveColor={this.props.indicatorInActiveColor} indicatorActiveWidth={this.props.indicatorActiveWidth} style={{ ...styles.indicator, ...this.props.indicatorStyle }} />
        )}
      </View>
    );
  }
  ...
  startAutoPlay = () => {
    this.sliderTimer = setInterval(this.incrementSliderListIndex, this.props.timer);
  };
